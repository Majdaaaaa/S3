...
public class Automate {
    ...
    // Renvoie le nombre de transitions dans l'automate
    ...
    // Renvoie l'ensemble des lettres utilisées dans l'automate.
    ...
    // Renvoie true si et seulement si l'automate est complet
    boolean estComplet() {
    ...
    // Renvoie true si et seulement si l'automate est déterministe
